  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-[0.7rem] tracking-[0.4em] uppercase text-pearl/70">
          {CONTENT.LOCATION}
        </span>
      </a>
      ...
      <a
        ...
        className="text-[0.65rem] uppercase tracking-[0.35em] px-4 py-2 border border-copper text-[#120d0a] bg-copper shadow-[0_0_20px_rgba(227,176,122,0.35)] hover:shadow-[0_0_30px_rgba(227,176,122,0.5)] transition-shadow"
      >
        Book a Call
      </a>
    </nav>
