  ...
  return (
    <section id="contact" className="relative py-[var(--spacing-section)] bg-[var(--color-obsidian)]">
      ...
      <div className="container-portfolio">
        <BlurFade>
          <p className="text-[0.65rem] tracking-[0.4em] uppercase text-pearl/55">Book a Call</p>
        ...
        <BlurFade delay={0.3}>
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8">
            <div className="edge-cut copper-trace surface-card p-6">
              ...
              <div className="mt-8 flex items-center gap-3 text-pearl/55">
        ...
        <BlurFade delay={0.35}>
          <div className="mt-12 flex flex-wrap gap-6 text-[0.7rem] uppercase tracking-[0.35em] text-pearl/55">
